...
import { View, Image, StyleSheet, Text, Dimensions, TouchableOpacity, ScrollView, CameraRoll, Permission, PermissionsAndroid } from 'react-native';
    ...
    render() {
        ...
        return (
            <View style={styles.mainView}>
                <HeaderBar
                    onPressLeft={() => {state.params.navBack()}}
